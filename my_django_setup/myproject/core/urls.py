...
router.register(r"step-inputs", views.StepInputMaterialViewSet, basename="stepinput")
router.register(r"step-outputs", views.StepOutputPartViewSet, basename="stepoutput")
